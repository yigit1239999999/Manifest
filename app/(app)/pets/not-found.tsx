...
export default async function PetsNotFound() {
  ...
  return (
    <NotFoundState
      ...
      actionHref="/pets"
      actionLabel={t("recordNotFound.backToList", { list: tNav("pets") })}
    />
  );
}
