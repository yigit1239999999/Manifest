...
export default async function VisitsNotFound() {
  ...
  return (
    <NotFoundState
      ...
      actionHref="/visits"
      actionLabel={t("recordNotFound.backToList", { list: tNav("visits") })}
    />
  );
}
